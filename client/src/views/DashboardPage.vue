...
const fetchUsers = async () => {
  try {
    ...
    const response = await fetch('https://hashvault.onrender.com/api/users');
    if (!response.ok) {
...
<template>
  <div class="w-full h-screen flex justify-center p-12 bg-black">
    <div class="w-[95%] mt-4">

      <div class="w-full flex justify-between items-center mb-3">
        <h1 class="font-semibold my-5 text-4xl text-white">IT412 MIDTERM PROJECT</h1>

        <div class="flex items-center gap-5 w-[35%] text-white ">
          <img src="/img/user_icon.png" alt="User Icon" width="50" height="60">
          ...
          <div @click="signOut" class="flex items-center gap-1 hover:opacity-75 hover:cursor-pointer">
            <img src="/img/logout.png" alt="User Icon" width="30" height="30">
            <h1>Sign Out</h1>
          </div>
